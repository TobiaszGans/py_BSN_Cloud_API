...
def _delete_request(url, params=None) -> dict:
...
def get_setups(page_number:int=1, page_size:int=100, network_name:str=None) -> dict:
...
def update_setup(setup_object:str, username:str=None) -> dict:
    ...
    return _put_request(url=url, data=setup_object)
...
# Control Endpoints
def put_device_reboot(serial_number: str, mode: str = None) -> dict:
...
def reset_device_ssh_host_keys(serial_number: str, reboot: bool = None) -> dict:
    '''
...
def reset_device_dws_default_certs(serial_number: str, reboot: bool = None) -> dict:
    '''
...
# Storage Endpoints
def get_device_files(serial_number:str, storage_type:str="sd", path:str=None, raw:bool=False, contents:bool=False) -> dict:
    '''
...
def put_device_files(serial_number: str, local_file_path: str, storage_type: str = "sd", 
                     file_path: str = None, dest_filename: str = None, 
...
def put_device_telnet_config(serial_number: str, enabled: bool, port_number: int = 23, 
                             password: str = None, reboot: bool = True) -> dict:
    '''
...
def put_device_ssh_config(serial_number: str, enabled: bool, port_number: int = 22, 
                         password: str = None, obfuscated_password: str = None, 
...
def get_device_video_current_mode(serial_number: str, mode_type: str = None,
                                  connector: str = "hdmi", device: int = 0) -> dict:
    '''
...
def set_device_video_mode(serial_number: str, mode_name: str, 
                          ...
                          color_depth: str = None, color_space: str = None,
                          overscan: bool = None) -> dict:
    '''
...
def delete_device_registry_key(serial_number: str, section: str, key: str = None) -> dict:
    '''
...
def update_display_firmware(serial_number: str, filepath: str = None, url: str = None) -> dict:
    '''
